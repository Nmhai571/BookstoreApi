...
var getOne = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var user, message, slug, voucher, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, Voucher_model_1["default"].findOne({ code: slug })];
            case 1:
                voucher = _a.sent();
                if (!voucher) {
                ...
                if (!voucher.active ||
                    ...
                    throw (0, error_1.handleError)(new Error("Voucher is not active"), 400);
